        ...
        <div class="card-body">
            <form action="{{ route('simpan_data_pendaftaran') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nama" placeholder="Nama" value="{{ old('nama') }}" id="nama" required>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" name="email" placeholder="Email" value="{{ old('email') }}" id="email" pattern=".+@.+\..+" required>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="nomor_hp" placeholder="Nomor HP" value="{{ old('nomor_hp') }}" id="nomor" required>
                        @error('nama') <label class="text-danger">{{ $message }}</label> @enderror
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" step="0.01" class="form-control" name="ipk" placeholder="IPK Terakhir" id="ipk" readonly required>
                ...
                <div class="mb-3 row">
                    ...
                    <select name="beasiswa" class="form-control col-md-2 m-2" style="width: 80%" id="beasiswa" disabled required>
                ...
                <div class="mb-3 row">
                    ...
                    <input name="berkas" accept=".pdf" class="form-control m-2" type="file" id="berkas" style="width: 80%" disabled required>
                    @error('berkas') <label class="text-danger">{{ $message }}</label> @enderror
                </div>
                <div class="mb-3 text-center align-content-center ">
                    <input type="submit" value="Daftar" class="form-control btn btn-primary text-center" style="width: 250px" id="daftar" />
                    <a href="{{ route("list-beasiswa") }}" class="btn btn-danger text-center" style="width: 250px" >Batal</a>
                </div>
            </form>
        </div>
